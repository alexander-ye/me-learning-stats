...
ggplot(data=samp1, mapping=aes(x=area)) + geom_histogram(binwidth=250)
```
...
ames %>% sample(size=50) %>% summarize(mean(price))
...
sample_means50
ggplot(data=sample_means50, mapping=aes(x=x_bar)) + geom_histogram()
...
sample_means150
ggplot(data=sample_means150, mapping=aes(x=x_bar)) + geom_histogram()

...
```{r}
sim_kobe_independent <- sample(shot_outcomes, size=133, replace=TRUE, prob=c(0.45, 0.55))
table(sim_kobe_independent)
```
...
sim_streak <- calc_streak(sim_kobe_independent)
sim_streak
